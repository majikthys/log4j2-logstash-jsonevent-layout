...
public class LogStashJSONLayoutIT {
	...
	private static final Logger logger = LogManager.getLogger(LogStashJSONLayoutIT.class);

	@Test(enabled=false, dataProvider = "dp")
	public void f(final Integer n, final String s) {
	}
	...
	private LogStashJSONLayout buildDefaultLayout() {
		return LogStashJSONLayout.createLayout(
	...
	public void BasicSimpleTest() throws JsonParseException, JsonMappingException, IOException{
		...
		LogStashJSONLayout layout = buildDefaultLayout();
...
//		System.out.println("++++++++++++++++++++++++++++++++++");
		...
		assertThat(mapper.writeValueAsString(resultLayout.get(LOCATION_INFO)), sameJSONAs(EXPECTED_LOCATION_INFO).allowingAnyArrayOrdering());
