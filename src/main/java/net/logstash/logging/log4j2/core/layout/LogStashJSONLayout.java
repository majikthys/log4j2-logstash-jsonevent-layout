...
public class LogStashJSONLayout extends AbstractStringLayout {
	private static final long serialVersionUID = -4156289624328386366L;
	...
	public static LogStashJSONLayout createLayout(
		...
		//When no layout is offered we'll go with the default pattern
		if (subLayout == null) {
